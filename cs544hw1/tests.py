...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_examples(self):
        ...
        a = """
My input text was two birds killed by one stone
but my NLP program read it as killed by one's tone
this program failed which made me sad
i debugged a lot and got real mad
how can i solve this unless i am jon may's clone
        """
